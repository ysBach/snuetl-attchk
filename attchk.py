...
p = argparse.ArgumentParser(
    description=(
        ...
        + '\nPercent            : "Minutes" / `totalminutes` (see arg -t)'
        + '\nFull participation : True if "Percent" > `fullpercent` (see arg -f)'
...
p.add_argument('-t', '--totalminutes', default=75, type=float,
               help='Total minutes, time for 100%% participation. Default = 75[min]')
p.add_argument('-f', '--fullpercent', default=70, type=float,
...
fpath = args.input
fulltime = args.totalminutes
fullperc = args.fullpercent
output = args.output
